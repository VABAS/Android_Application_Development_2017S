package net.siekkiset.jesse.androidcourse2017s.exercise6;
...
public class MainActivity extends AppCompatActivity {
    ...
    // Image's path.
    private final String PATH = "https://jesse.siekkiset.net/kuvat/";
    // Image names.
    private String[] images = {"mie.png","ilme.jpg","tt_scaled.jpg"};
